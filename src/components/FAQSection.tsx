...
const faqs = [
  {
    ...
    a: 'Dom znajduje się w miejscowości Konne koło Supraśla, w Puszczy Knyszyńskiej — około 10 minut samochodem od centrum Supraśla i 25 minut od Białegostoku.',
  },
  {
  ...
  },
  {
    ...
    a: 'Tak, In The Woods znajduje się w sercu Puszczy Knyszyńskiej przy rezerwacie Krzemienne Góry. To jeden z nielicznych domów na wynajem otoczonych prawdziwą puszczą.',
  },
  {
  ...
  },
  {
    ...
    a: 'In The Woods oferuje prywatną ruską banię z balią z gorącą wodą — idealne wieczorne SPA pod gwiazdami, dostępne jako dodatek do pobytu za 250 zł.',
  },
  {
    q: 'Czy jest jacuzzi / ruska bania?',
    a: 'Tak — do dyspozycji gości jest prywatna ruska bania z balią z gorącą wodą, dostępna jako opcjonalny dodatek do pobytu za 250 zł.',
  },
  {
    q: 'Czy dom jest prywatny?',
    a: 'Tak — dom i cały ogród wynajmujecie na wyłączność. Żadnych innych gości.',
  },
  {
    q: 'Czy można przyjechać z psem?',
    a: 'Tak, zwierzęta są mile widziane. Pobyt z psem jest bezpłatny. Ogrodzony ogród i las za progiem to raj dla czworonogów.',
  },
  {
  ...
  {
    q: 'Czy jest internet?',
    a: 'Tak — szybkie Wi-Fi, wygodne miejsce do pracy. Idealne warunki na workation.',
  },
  {
