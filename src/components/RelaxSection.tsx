      ...
      <div ref={ref} className={`max-w-7xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-16">
          <div className="overflow-hidden relative group">
            <img src={baniaImg} alt="Prywatna ruska bania — sauna ogrodowa w In The Woods Supraśl" className="w-full h-[350px] md:h-[450px] object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
