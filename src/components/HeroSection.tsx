  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={jacuzziImg} alt="Noclegi Supraśl — prywatna ruska bania nocą w Krzemiennej Chacie, Puszcza Knyszyńska" className="w-full h-full object-cover" loading="eager" fetchPriority="high" />
