  ...
  return (
    <section className="relative">
      <div className="relative h-[50vh] min-h-[350px]">
        <img src={winterGolden} alt="Noclegi Supraśl zimą — In The Woods w złotym zimowym świetle Puszczy Knyszyńskiej" className="w-full h-full object-cover" loading="lazy" />
