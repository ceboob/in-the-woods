  ...
  return (
    <section className="relative">
      <div className="relative h-[50vh] min-h-[350px]">
        <img
          src={winterGolden}
          alt="Chata In The Woods zimą w złotym świetle — noclegi Supraśl Puszcza Knyszyńska"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-6 max-w-2xl">
            <h2 className="font-serif text-3xl md:text-5xl font-light text-cream mb-4">
              Zimą jak z bajki
            </h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-12 space-y-4">
            <p className="section-subtitle">
              ...
              ciszę przerywają tylko odgłosy dzięcioła, nasz dom zamienia się w przytulny azyl. Rano
              rozpalasz kominek, parzysz kawę i obserwujesz las za oknem. Po południu spacer po
              zaśnieżonych szlakach albo narty biegowe wśród sosen. A wieczorem — gorąca bania pod
              rozgwieżdżonym zimowym niebem i powrót do ciepłego domu.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            <div className="overflow-hidden">
              <img
                src={winterCabin}
                alt="Drewniana chata w śnieżnej Puszczy Knyszyńskiej — zimowy nocleg Supraśl"
            ...
            <div className="overflow-hidden">
              <img
                src={winterForest}
                alt="Zaśnieżony las Puszczy Knyszyńskiej — zimowe szlaki blisko Supraśla"
                className="w-full h-[280px] md:h-[350px] object-cover hover:scale-105 transition-transform duration-700"
                loading="lazy"
                width="800"
                height="350"
