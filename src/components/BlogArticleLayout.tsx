  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://suprasl.online/blog' },
      {
        ...
        position: 3,
        name: title,
        item: `https://suprasl.online/blog/${slug}`,
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <link rel="canonical" href={`https://suprasl.online/blog/${slug}`} />
        <meta property="og:title" content={metaTitle} />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:url" content={`https://suprasl.online/blog/${slug}`} />
      ...
      <nav className="bg-background border-b border-border sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/blog" className="nav-link text-foreground/70 hover:text-foreground">
              Blog
            </Link>
            <Link
              to="/noclegi-suprasl"
      ...
      <section className="px-6 md:px-12 py-16 bg-secondary">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-foreground/70 max-w-xl mx-auto">
            Jeśli szukasz komfortowego noclegu w Supraślu, In The Woods oferuje prywatny dom w lesie
            z jacuzzi i kominkiem.
          </p>
