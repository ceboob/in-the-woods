...
const DomekSuprasl = () => (
  <SEOPageLayout
    ...
    description="Domek Supraśl na wyłączność — kominek, jacuzzi, ogród i cisza Puszczy Knyszyńskiej. Idealny na weekend!"
  ...
  >
    <article className="prose prose-lg max-w-none space-y-8">
      <h1 className="section-title !text-3xl md:!text-4xl lg:!text-5xl mb-6">
        Domek Supraśl – Twój prywatny azyl w Puszczy Knyszyńskiej
      </h1>

      <p className="text-muted-foreground leading-relaxed text-lg">
        Szukasz <strong>domku w Supraślu</strong> na wyłączność? In The Woods to drewniany dom
        otoczony lasem, położony zaledwie 10 minut od centrum Supraśla, przy rezerwacie przyrody
        Krzemienne Góry. To nie jest kolejny „domek letniskowy" — to miejsce, które zmienia sposób,
        w jaki odpoczywasz.
      </p>

      <h2 className="section-title !text-2xl md:!text-3xl">
        Dlaczego warto wybrać domek w Supraślu
      </h2>
      <p className="text-muted-foreground leading-relaxed">
        Supraśl to uzdrowiskowe miasteczko w województwie podlaskim, otoczone Puszczą Knyszyńską —
        jednym z największych kompleksów leśnych w Polsce. Wybierając <strong>domek Supraśl</strong>
        , wybierasz ciszę starego lasu, zapach żywicy i poranki, w których jedynym budzikiem jest
        śpiew ptaków.
      </p>
      <p className="text-muted-foreground leading-relaxed">
        In The Woods to <strong>dom na wynajem w Supraślu</strong>, który wynajmujesz na wyłączność.
        Żadnych sąsiednich pokoi, żadnych obcych gości — cała posiadłość jest tylko dla Ciebie i
        Twoich bliskich. To fundamentalna różnica w porównaniu z hotelem czy pensjonatem.
      </p>
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        gwiazdami. Gorąca woda, zimne powietrze Puszczy Knyszyńskiej i niebo pełne gwiazd — to
        rytuał, który goście wspominają najczęściej.
      </p>
      <p className="text-muted-foreground leading-relaxed">
        Nasz <strong>domek Supraśl z jacuzzi</strong> to idealne miejsce na romantyczny weekend we
        dwoje, ale też na rodzinny wypad czy spotkanie w gronie przyjaciół. Balia mieści do 6 osób i
        jest dostępna jako opcja dodatkowa do każdego pobytu.
      </p>

      <h2 className="section-title !text-2xl md:!text-3xl">
        Lokalizacja — las i miasto w zasięgu ręki
      </h2>
      <p className="text-muted-foreground leading-relaxed">
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        zaczynają się dosłownie za płotem. Białystok z bogatą ofertą gastronomiczną i kulturalną
        jest oddalony o 25 minut jazdy.
      </p>
      ...
      <p className="text-muted-foreground leading-relaxed">
        Zwierzęta domowe są u nas mile widziane bezpłatnie. Ogrodzony ogród i kilometr leśnych
        ścieżek to raj dla czworonogów. A wieczorne ognisko pod gwiazdami? To wspomnienie, które
        zostaje na lata.
      </p>

      <h2 className="section-title !text-2xl md:!text-3xl">Cennik i rezerwacja</h2>
      <p className="text-muted-foreground leading-relaxed">
        Ceny zaczynają się od 399 PLN za noc w sezonie niskim. Rezerwacja jest bezpośrednia — bez
        prowizji pośredników. Wystarczy zadzwonić lub napisać. Odpowiadamy zwykle w kilka godzin.
      </p>
      <p className="text-muted-foreground leading-relaxed">
