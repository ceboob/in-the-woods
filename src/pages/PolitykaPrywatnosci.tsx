...
const PolitykaPrywatnosci = () => {
  return (
    <>
      <Helmet>
        <title>Polityka prywatności i cookies | Krzemienna Chata</title>
        <meta
          name="description"
          content="Polityka prywatności, cookies i RODO obiektu Krzemienna Chata w Supraślu. Dowiedz się jak przetwarzamy Twoje dane."
        />
      </Helmet>
      <Navbar />
