...
const CoRobicSuprasl = () => (
  <BlogArticleLayout
    ...
    metaDescription="Co robić w Supraślu? Monaster, Muzeum Ikon, kajaki, szlaki i kuchnia regionalna. Przewodnik po najważniejszych atrakcjach."
    ...
    faqs={[
      ...
      },
      {
        ...
        answer:
          'Na główne atrakcje Supraśla wystarczą 2 dni, ale żeby naprawdę poczuć magię tego miejsca, warto zostać co najmniej 3-4 dni.',
      },
      {
        question: 'Czy Supraśl jest dobry na weekendowy wypad?',
        answer:
          'Tak, Supraśl to idealne miejsce na weekend — uzdrowiskowy klimat, atrakcje turystyczne i bliskość natury w zasięgu ręki.',
      },
    ]}
    relatedArticles={[
  ...
  >
    <h2>Co robić w Supraślu? Kompletny przewodnik po atrakcjach</h2>

    <p>
      Supraśl to jedno z najpiękniejszych miasteczek Podlasia — uzdrowisko w sercu Puszczy
      Knyszyńskiej, które łączy historię, kulturę i naturę w unikalny sposób. Niezależnie od tego,
      czy planujesz
      <Link to="/weekend-suprasl"> weekend w Supraślu</Link>, dłuższy urlop czy jednodniową
      wycieczkę — ten przewodnik pomoże Ci zaplanować czas tak, by nie ominąć niczego ważnego.
    </p>

    <h2>Monaster Zwiastowania NMP — duchowe serce Supraśla</h2>
    <p>
      Prawosławny Monaster Zwiastowania Najświętszej Maryi Panny to najważniejszy zabytek Supraśla i
      jedno z najcenniejszych miejsc sakralnych w Polsce. Kompleks klasztorny, założony w XVI wieku,
      zachwyca architekturą, spokojem i duchową atmosferą. Odwiedzający mogą wejść do soboru,
      spacerować po klasztornych ogrodach i uczestniczyć w nabożeństwach z pięknym śpiewem
      liturgicznym.
    </p>
    ...
    <p>
      Spacer bulwarami nad rzeką Supraśl to jeden z najprzyjemniejszych sposobów na spędzenie
      popołudnia. Rzeka płynie spokojnie wśród zieleni, a wzdłuż niej ciągną się ścieżki spacerowe,
      ławki i punkty widokowe. Latem można tu obserwować kajakarzy, a jesienią — podziwiać złociste
      kolory puszczy odbijające się w wodzie.
    </p>
    ...
    <p>
      ...
      — meandrująca rzeka, zwalone drzewa, bobry i czaple. Trasy mają różną długość (od 2 do 6
      godzin) i są dostępne nawet dla początkujących.
    </p>

    <h2>Kuchnia regionalna Podlasia</h2>
    <p>
      Pobyt w Supraślu to doskonała okazja, by spróbować kuchni podlaskiej. Kartacze (kluski
      ziemniaczane z mięsnym farszem), babka ziemniaczana, kiszka ziemniaczana czy sękacz — to
      smaki, których nie znajdziesz nigdzie indziej. Sprawdź nasz{' '}
      <Link to="/blog/restauracje-suprasl">przewodnik po restauracjach Supraśla</Link> z naszymi
      autorskimi rekomendacjami.
    </p>

    <h2>Kruszyniany — tatarska wieś</h2>
    <p>
      Zaledwie 40 minut od Supraśla znajdują się{' '}
      <Link to="/blog/kruszyniany-tatarska-wies">Kruszyniany</Link> — jedna z najstarszych
      tatarskich osad w Polsce. Drewniany meczet z XVIII wieku, cmentarz muzułmański i tradycyjna
      kuchnia tatarska (pierekaczewnik, kibiny, czebureki) to doświadczenie kulturowe jedyne w swoim
      rodzaju.
    </p>
    ...
    <p>
      Jeśli szukasz <Link to="/noclegi-suprasl">noclegu w Supraślu</Link>, który oferuje coś więcej
      niż standardowy hotel — In The Woods to prywatny{' '}
      <Link to="/domek-suprasl">domek w Supraślu</Link> na wyłączność, z kominkiem, jacuzzi i
      ogrodem w Puszczy Knyszyńskiej. To idealna baza wypadowa na odkrywanie wszystkich atrakcji
      regionu.
    </p>
