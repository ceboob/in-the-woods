...
const WydarzeniaSupra2026 = () => (
  ...
  >
    <div className="prose mx-auto my-8 not-prose">
      <img loading="lazy" decoding="async" sizes="(min-width: 768px) 768px, 100vw" width="1536" height="878" src="/images/lato-2026-suprasl.jpg" alt="Plakat: LATO 2026 – kulturalny rozkład jazdy w Supraślu; daty i miejsca wydarzeń" className="w-full max-w-3xl mx-auto rounded-lg shadow-md" />
