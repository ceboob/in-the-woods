  ...
  >
    <article className="prose prose-lg max-w-none space-y-8">
      <h1 className="section-title !text-3xl md:!text-4xl lg:!text-5xl mb-6">
        Dom w lesie na wyłączność — domek na odludziu w Puszczy Knyszyńskiej
      </h1>
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        piesze zaczynają się tuż za progiem domu. To <strong>spokojny wypoczynek w naturze</strong>,
      ...
      <h2 className="section-title !text-2xl md:!text-3xl">
        Domek na odludziu podlaskie — co warto wiedzieć
      </h2>
      <p className="text-muted-foreground leading-relaxed">
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        numer 722 765 101 lub wyślij zapytanie przez formularz na stronie głównej.
      </p>
      <p className="text-muted-foreground leading-relaxed">
