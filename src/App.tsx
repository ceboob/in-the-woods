...
const SzlakPowstaniaStyczniowego = lazy(
  () => import('./pages/blog/SzlakPowstaniaStyczniowego.tsx'),
);
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route
                ...
                element={<NajlepszeMiejscaPuszcza />}
              />
              <Route
