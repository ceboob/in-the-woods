...
const GoogleLogo = ({ className }) => /* @__PURE__ */ jsxs("svg", { className, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: [
...
const BookingLogo = ({ className }) => /* @__PURE__ */ jsxs("svg", { className, viewBox: "0 0 40 40", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsx("rect", { width: "40", height: "40", rx: "6", fill: "#003580" }),
  /* @__PURE__ */ jsx("text", { x: "8", y: "29", fill: "white", fontSize: "24", fontWeight: "bold", fontFamily: "Arial,Helvetica,sans-serif", children: "B" }),
  /* @__PURE__ */ jsx("circle", { cx: "30", cy: "28", r: "3", fill: "#003580", stroke: "white", strokeWidth: "2" })
] });
const AirbnbLogo = ({ className }) => /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm5.7 17.3c-.5.8-1.1 1.5-1.9 2-.8.5-1.6.7-2.5.7-.6 0-1.2-.1-1.7-.4-.5-.2-1-.6-1.6-1.1-.6.5-1.1.8-1.6 1.1-.5.3-1.1.4-1.7.4-.9 0-1.7-.2-2.5-.7-.8-.5-1.4-1.2-1.9-2-.5-.9-.7-1.8-.7-2.8 0-.7.1-1.4.4-2.1.3-.7.6-1.3 1.1-1.9.5-.6 1-1.2 1.5-1.7.5-.5 1.1-1.1 1.7-1.7l1.2-1.2c.3-.3.5-.5.7-.8.2-.2.3-.4.4-.5.1-.1.2-.2.2-.2l.1-.1.1.1.2.2c.1.1.2.3.4.5.2.3.4.5.7.8l1.2 1.2c.6.6 1.2 1.2 1.7 1.7.5.5 1 1.1 1.5 1.7.5.6.8 1.2 1.1 1.9.3.7.4 1.4.4 2.1 0 1-.2 1.9-.7 2.8z", fill: "#FF5A5F" }) });
const DogInclusiveLogo = ({ className }) => /* @__PURE__ */ jsxs("svg", { className, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsx("path", { d: "M18 4c-1 0-2 .5-2.8 1.3l-.6.7c-.3-.5-.8-1-1.6-1-.6 0-1.1.3-1.5.7L10 7.5l-1-1c-.5-.5-1.1-.8-1.8-.8C5.4 5.7 4 7.1 4 8.9c0 .9.4 1.7 1 2.3L12 18l7-6.8c.6-.6 1-1.4 1-2.3C20 7.1 19.1 5.3 18 4z", fill: "#8B6914" }),
  /* @__PURE__ */ jsx("circle", { cx: "7.5", cy: "3", r: "2", fill: "#8B6914" }),
  /* @__PURE__ */ jsx("circle", { cx: "16.5", cy: "3", r: "2", fill: "#8B6914" }),
  /* @__PURE__ */ jsx("path", { d: "M4 12c-1 1-2.5 3-2 5s2 3 4 3c1 0 2-.5 2.5-1", fill: "none", stroke: "#8B6914", strokeWidth: "1.5", strokeLinecap: "round" }),
  /* @__PURE__ */ jsx("path", { d: "M20 12c1 1 2.5 3 2 5s-2 3-4 3c-1 0-2-.5-2.5-1", fill: "none", stroke: "#8B6914", strokeWidth: "1.5", strokeLinecap: "round" })
] });
const sourceConfig = {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 space-y-4", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs tracking-[0.3em] uppercase text-muted-foreground font-sans", children: "Opinie gości" }),
          /* @__PURE__ */ jsx("h2", { className: "section-title", children: "Co mówią ci, którzy tu byli" }),
          /* @__PURE__ */ jsx("p", { className: "section-subtitle mx-auto", children: "4,82★ na podstawie 110 opinii — oto kilka historii naszych gości." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 lg:grid-cols-4 gap-8", children: testimonials.map((t, i) => {
          const src = sourceConfig[t.source];
          const Logo = src.logo;
          return /* @__PURE__ */ jsxs("div", { className: "card-premium space-y-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("div", { className: "flex gap-1", children: [...Array(5)].map((_, j) => /* @__PURE__ */ jsx(
                Star,
                {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(Logo, { className: "h-4 w-auto" }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-medium tracking-wide uppercase text-muted-foreground", children: src.label })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-foreground/80 leading-relaxed text-sm text-smallcaps", children: [
              "„",
              t.text,
              '"'
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-medium", children: t.author }),
              /* @__PURE__ */ jsx("p", { className: "text-[11px] text-muted-foreground", children: t.context })
            ] })
          ] }, i);
        }) })
      ]
