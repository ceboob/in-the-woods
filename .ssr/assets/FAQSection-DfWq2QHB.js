    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 space-y-4", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs tracking-[0.3em] uppercase text-muted-foreground font-sans", children: "FAQ" }),
          /* @__PURE__ */ jsx("h2", { className: "section-title", children: "Najczęściej pytacie" })
        ] }),
        /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "space-y-2", children: faqs.map((faq, i) => /* @__PURE__ */ jsxs(AccordionItem, { value: `faq-${i}`, className: "border-b border-border", children: [
          /* @__PURE__ */ jsx(AccordionTrigger, { className: "font-heading text-lg font-medium text-left hover:no-underline py-5", children: faq.q }),
